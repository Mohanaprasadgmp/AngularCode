...
declare namespace connect {
   ...
   */
  type UserMediaDeviceChangeCallback = (
    userMediaDeviceChange: UserMediaDeviceChange
  ) => void;
  ...
  type SoftphoneCallback = (callback: any) => void;
  /**
  ...
  function onWebsocketInitFailure(callback: WebSocketCallBack): void;
  function onSoftphoneSessionInit(callback: SoftphoneCallback): void;
   ...
   */
  function hitch<T extends (...args: any[]) => any>(
    scope: object,
    method: T
  ): T;
  ...
  class Agent {
     ...
     */
    createTask(
      taskContact: TaskContactDefinition,
      callbacks?: SuccessFailOptions
    ): void;
